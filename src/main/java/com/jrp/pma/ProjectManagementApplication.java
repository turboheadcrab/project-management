...
public class ProjectManagementApplication {
    ...
    CommandLineRunner runner() {
        return args -> {
            ...
            Project pro1 = new Project("Large Production Deploy",
                    "NOTSTARTED",
                    "This requires all hands on deck for the final deployment of the software into production");
            Project pro2 = new Project("New Employee Budget",
                    "COMPLETED",
                    "Decide on a new employee bonus budget for the year and figure out who will be promoted");
            Project pro3 = new Project("Office Reconstruction",
                    "INPROGRESS",
                    "The office building in Monroe has been damaged due to hurricane in the region. This needs to be " +
                            "reconstructed");
            Project pro4 = new Project("Improve Intranet Security",
                    "INPROGRESS",
                    "With the recent data hack, the office security needs to be improved and proper security team " +
                            "needs to be hired for implementation");
